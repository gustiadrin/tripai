...
//   chat = inject(ChatService);
//   theme = signal<'light' | 'dark'>(
//     (localStorage.getItem('tripai_theme') as 'light' | 'dark') || 'light'
//   );

//   constructor() {
//     this.chat.loadMessagesOnce();
...
//     // Añadir respuesta del bot inmediatamente; el polling la confirmará
//     if (reply) {
//       this.chat.messages.update((m: ChatMessage[]) => [
//         ...m,
//         { sender: 'bot', content: reply, timestamp: new Date().toISOString() },
//       ]);
//     }
//   }
